...
public class ApplicationConfiguration {
	...
	UserDetailsService getUserDetailsService() {
		System.out.println("getUserDetailsService Called ");
		System.out.println("userRepo" +userRepo.existsById(1));
	...
	AuthenticationProvider authenticationProvider() {
		...
		System.out.println("getUserDetailsService " + getUserDetailsService());
		System.out.println("DaoAuthenticationProvider Called " + provider.toString());
		return provider;
	}
